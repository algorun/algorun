                ...
                if (!err){
                    for(i in output_files){
                        ...
                        if(output.src === 'stdout'){
                            output_dict[output.name] = stdout;
                        } else {
                        	if(output.type.includes("image")){
                        		inStr = fs.createReadStream(process.env.CODE_HOME + output.src)
                        		outStr = fs.createWriteStream(process.env.CODE_HOME +"/web/images/" + output.src)
                        		output_dict[output.name] = "/images/" + output.src
                        	} else {
